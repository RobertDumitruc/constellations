...
const constellations = {
    "Amen Break": {
        name: "The 'Amen Break'",
        songs: [
            { id: 1, title: "Amen, Brother", artist: "The Winstons", year: 1969, x: 0.5, y: 0.5, isSource: true, sample: "The foundational 6-second drum solo that became one of the most sampled breaks in history.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/The Winstons - Amen Brother - (320 Kbps).mp3", startTime: 86 }] },
            { id: 2, title: "Straight Outta Compton", artist: "N.W.A.", year: 1988, x: 0.3, y: 0.35, sample: "The iconic drum loop provides the track's raw backbone.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/N.W.A. - Straight Outta Compton (Official Music Video) - (256 Kbps).mp3", startTime: 4 }] },
            { id: 3, title: "King of the Beats", artist: "Mantronix", year: 1988, x: 0.7, y: 0.25, sample: "One of the earliest hip-hop tracks to popularize the Amen Break.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/Mantronix - King Of The Beats - (320 Kbps).mp3", startTime: 19 }] },
            { id: 4, title: "I Desire", artist: "Salt-N-Pepa", year: 1986, x: 0.65, y: 0.7, sample: "The break is pitched down and slowed down.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/Salt-N-Pepa - I Desire - (320 Kbps).mp3", startTime: 3 }] },
            { id: 5, title: "Pigs", artist: "Tyler, The Creator", year: 2013, x: 0.35, y: 0.75, sample: "Samples both the Amen Break and Jay-Z's '99 Problems'.", sound: [{ name: "'Pigs'", src: "audio/AmenBreak/Tyler, The Creator - Pigs - (256 Kbps).mp3", startTime: 0 }, { name: "'99 Problems' Vocals", src: "audio/AmenBreak/Tyler, The Creator - Pigs - (256 Kbps).mp3", startTime: 249 }], connectsTo: [1, 8] },
            { id: 6, title: "Sugar On My Tongue", artist: "Tyler, The Creator", year: 2011, x: 0.85, y: 0.45, sample: "Features a sample from Mantronix's 'King of the Beats'.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/Tyler, The Creator - Sugar On My Tongue (audio) - (320 Kbps).mp3", startTime: 139 }], connectsTo: 3 },
            { id: 7, title: "The Mission", artist: "Special Ed", year: 1990, x: 0.74, y: 0.6, sample: "The lyrics of 'I desire' are featured in this song.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/Special Ed - The Mission - Legal - (320 Kbps).mp3", startTime: 2 }], connectsTo: 4 },
            { id: 8, title: "99 Problems", artist: "Jay-Z", year: 2003, x: 0.15, y: 0.6, sample: "Its drum pattern is iconic.", sound: [{ name: "Play Sample", src: "audio/AmenBreak/JAY-Z - 99 Problems - (320 Kbps).mp3", startTime: 0 }], isGuest: true }
        ]
    },
    "Funky Drummer": {
        name: "The 'Funky Drummer'",
        songs: [
            { id: 1, title: "Funky Drummer", artist: "James Brown", year: 1970, x: 0.5, y: 0.53, isSource: true, sample: "Clyde Stubblefield's legendary drum break.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/James Brown - Funky Drummer (Full Version, 1970) - HQ - (128 Kbps).mp3", startTime: 322, durationSeconds: 8 }] },
            { id: 2, title: "Rebel Without a Pause", artist: "Public Enemy", year: 1987, x: 0.31, y: 0.66, sample: "The break is chopped and layered to create a chaotic rhythm, with the lift from The JB's 'The Grunt' landing in the same moment.", sound: [{ name: "'Rebel Without a Pause'", src: "audio/FunkyDrummer/Public Enemy - Rebel Without A Pause - (256 Kbps).mp3", startTime: 12, durationSeconds: 10 }] },
            { id: 3, title: "Fight the Power", artist: "Public Enemy", year: 1989, x: 0.33, y: 0.41, sample: "Drives forward on a hard, urgent groove, with a sample from Syl Johnson's 'Different Strokes' landing later in the track.", sound: [{ name: "'Fight the Power'", src: "audio/FunkyDrummer/Public Enemy - Fight The Power - (256 Kbps).mp3", startTime: 13, durationSeconds: 10 }, { name: "'Different Strokes' Sample", src: "audio/FunkyDrummer/Public Enemy - Fight The Power - (256 Kbps).mp3", startTime: 140, durationSeconds: 10 }] },
            { id: 4, title: "The Originators", artist: "The Jaz", year: 1988, x: 0.68, y: 0.34, sample: "Pulls the break into late-'80s rap production with a crisp, propulsive loop and a nod to Last Ward.", sound: [{ name: "'The Originators'", src: "audio/FunkyDrummer/The Jaz - The Originators - (256 Kbps).mp3", startTime: 17, durationSeconds: 10 }, { name: "'Keep On Bumpin'' Sample", src: "audio/FunkyDrummer/The Jaz - The Originators - (256 Kbps).mp3", startTime: 28, durationSeconds: 10 }] },
            { id: 5, title: "Let Me Ride", artist: "Dr. Dre", year: 1992, x: 0.72, y: 0.57, sample: "Loops the Funky Drummer break into a laid-back G-funk cruise, with Parliament surfacing later in the arrangement.", sound: [{ name: "'Let Me Ride'", src: "audio/FunkyDrummer/Dr. Dre - Let Me Ride - (256 Kbps).mp3", startTime: 68, durationSeconds: 10 }, { name: "'Swing Down, Sweet Chariot' Sample", src: "audio/FunkyDrummer/Dr. Dre - Let Me Ride - (256 Kbps).mp3", startTime: 219, durationSeconds: 10 }] },
            { id: 6, title: "Powerpuff Girls Theme", artist: "Cartoon Network", year: 1998, x: 0.55, y: 0.77, sample: "Even the cartoon theme borrows the same breakbeat energy, showing how far the groove traveled.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/The Powerpuff Girls _ Theme Song _ Cartoon Network - (256 Kbps).mp3", startTime: 32, durationSeconds: 10 }] },
            { id: 7, title: "Keep On Bumpin' Before You Give Out Of Gas", artist: "Last Ward", year: 1974, x: 0.81, y: 0.23, sample: "A deep funk cut whose groove resurfaces in The Jaz's 'The Originators'.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/Last Ward - Keep On Bumpin' Before You Give Out Of Gas.wmv - (320 Kbps).mp3", startTime: 51, durationSeconds: 10 }], isGuest: true, connectsTo: 4 },
            { id: 8, title: "Swing Down, Sweet Chariot", artist: "Parliament", year: 1977, x: 0.89, y: 0.46, sample: "Its vocal and funk texture echo through Dr. Dre's 'Let Me Ride'.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/Parliament - Swing Down, Sweet Chariot (Live_1977) - (256 Kbps).mp3", startTime: 52, durationSeconds: 10 }], isGuest: true, connectsTo: 5 },
            { id: 9, title: "Different Strokes", artist: "Syl Johnson", year: 1967, x: 0.16, y: 0.49, sample: "A famous break source that turns up inside 'Fight the Power'.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/Syl Johnson  Different Strokes - (320 Kbps).mp3", startTime: 27, durationSeconds: 10 }], isGuest: true, connectsTo: 3 },
            { id: 10, title: "The Grunt", artist: "The JB's", year: 1970, x: 0.17, y: 0.8, sample: "A foundational funk riff sampled by 'Rebel Without a Pause'.", sound: [{ name: "Play Sample", src: "audio/FunkyDrummer/The JB's-The Grunt. - (320 Kbps).mp3", startTime: 0, durationSeconds: 10 }], isGuest: true, connectsTo: 2 }
        ]
    }
};
